...
const SaleDetailView = ({ sale, currentUser }) => {
  ...
  return (
    <main className="relative w-[1920px] min-h-[2185px] bg-[#161616] text-white">
      ...
      <p className="absolute right-[340px] top-[140px] text-white">by {sale.seller.nickname}</p>
      ...
      {/* 설명 */}
      <p className="absolute left-[1181px] top-[373px] w-[400px] text-sm text-gray-300 leading-relaxed">
        {sale.description}
      </p>

      {/* 구분선 */}
      <div className="absolute right-[339px] top-[553px] w-[400px] h-[1px] bg-gray-600" />

      {/* 구매 포인트 */}
      <div className="absolute left-[1181px] top-[593px] w-[400px] flex items-center justify-between">
        <span className="text-sm text-gray-400">구매 포인트</span>
      ...
      <div className="absolute left-[1181px] top-[643px] w-[400px] flex items-center gap-[273px]">
        <span className="text-sm text-gray-400">교환희망여부</span>
        <input
          type="checkbox"
      ...
      {/* 버튼 */}
      <div className="absolute left-[1181px] top-[900px] w-[400px] flex flex-col gap-2 items-end">
